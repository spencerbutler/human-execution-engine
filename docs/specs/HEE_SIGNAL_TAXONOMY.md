...
This specification defines the complete taxonomy of signals within HEE SVL scope.
All signals must be classified into exactly one of the defined classes.
