...
This repo enforces **strong Git/GH governance** so agents cannot improvise
unsafe sequences. Any **mutating** git/gh operation must be executed through
a single guarded entrypoint script:
