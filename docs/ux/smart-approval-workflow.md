...
## Overview
The smart approval workflow automatically determines whether commands require explicit user approval based on safety profiles, reducing friction for safe operations while maintaining security for risky ones.
...
### Overview
The Eye Candy system provides extensible metrics visualization for smart approval systems, enabling stakeholders to monitor system health, decision patterns, and performance trends through beautiful, interactive dashboards.
