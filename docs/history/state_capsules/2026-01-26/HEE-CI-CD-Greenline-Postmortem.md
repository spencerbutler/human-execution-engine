...
A multi‑day CI/CD hardening effort surfaced several failure modes that were not
defects in business logic or governance intent, but in *implementation mechanics*,
specifically GitHub Actions YAML structure, shell execution boundaries, and
incorrect assumptions about how to detect merge conflicts.
